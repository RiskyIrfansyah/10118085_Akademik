...
<body>
	<div class="container-fluid bg-light">
		...
		<div class="container col-md-6">
			<form method="post" action="cek-pengajar.php">
				...
				<div class="form-group">
				    <label for="nama_guru">NAMA PENGAJAR</label>
				    <input type="text" class="form-control" id="nama_guru" name="nama_guru">
				</div>
				<div class="form-group">
				    <label for="pelajaran">PELAJARAN</label>
				    <input type="textarea" class="form-control" id="pelajaran" name="pelajaran">
				</div>
				...
				<?php
					...
					while ($d = mysqli_fetch_array($data)) {
						...
						<tr>
							...
							<td>
								<a href="form-edit-pengajar.php?nip=<?php echo $d['nip']; ?>">EDIT</a>
